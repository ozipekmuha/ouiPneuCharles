        ...
        <main class="admin-content-area">
            ...
            <div class="client-details-grid">
                <div class="detail-card client-info-card">
                    ...
                    <p><strong>Nom:</strong> <?php echo sanitize_html_output(trim($client_details['prenom'] . ' ' . $client_details['nom'])); ?></p>
                    <p><strong>Email:</strong> <?php echo sanitize_html_output($client_details['email']); ?></p>
                    <p><strong>Téléphone:</strong> <?php echo sanitize_html_output($client_details['telephone'] ?: 'Non fourni'); ?></p>
                    <p><strong>Date d'inscription:</strong> <?php echo sanitize_html_output(date("d/m/Y H:i", strtotime($client_details['date_inscription']))); ?></p>
